...
Lebnix LXDE is free and open source software.

**You are free to:**
- Use Lebnix LXDE for any purpose
...
### Step 1: Download
Download the latest ISO from [SourceForge Mirror](https://sourceforge.net/projects/wolfos/files/)
